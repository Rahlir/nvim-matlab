...
if g:matlab_auto_mappings
  ...
  nnoremap <buffer><silent> <C-b> :MatlabNormalModeCreateCell<CR>
  vnoremap <buffer><silent> <C-b> :<C-u>MatlabVisualModeCreateCell<CR>
  inoremap <buffer><silent> <C-b> <C-o>:MatlabInsertModeCreateCell<CR>
endif
